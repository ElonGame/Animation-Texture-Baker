...
namespace AnimationBaker.StateMachine.XNode
{
    ...
    public abstract class Node : ScriptableObject
    {
        ...
        // [SerializeField] public List<NodeConnection> connections = new List<NodeConnection>();
        ...
        public virtual void OnCreateConnection(NodePort from, NodePort to, NodeConnection connection) { }

        /// <summary> Called after a connection is removed from this port </summary>
        /// <param name="port">Output or Input</param>
        public virtual void OnRemoveConnection(NodePort port, NodeConnection connection) { }
