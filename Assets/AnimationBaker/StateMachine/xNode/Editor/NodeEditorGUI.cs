...
using AnimationBaker.StateMachine.Editor;
...
namespace AnimationBaker.StateMachine.XNodeEditor
{
    ...
    public partial class NodeEditorWindow
    {
        ...
        private List<AnimationBaker.StateMachine.XNode.Node> culledNodes;
        ...
        private void OnGUI()
        {
            ...
            DrawGrid(position, zoom, graph.dragPosition);
            DrawConnections();
            ...
            foreach (AnimationBaker.StateMachine.XNode.Node node in graph.nodes)
            {
                ...
                foreach (AnimationBaker.StateMachine.XNode.NodePort output in node.Outputs)
                {
                    ...
                    for (int k = 0; k < output.ConnectionCount; k++)
                    {
                        ...
                        if (!input.IsConnectedToPort(output)) input.Connect(output);
        ...
        private void DrawNodes()
        {
            ...
            if (e.type == EventType.Layout) culledNodes = new List<AnimationBaker.StateMachine.XNode.Node>();
        ...
        private bool ShouldBeCulled(AnimationBaker.StateMachine.XNodeEditor.NodeEditor nodeEditor)
        {
