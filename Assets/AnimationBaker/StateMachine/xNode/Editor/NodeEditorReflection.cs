...
namespace AnimationBaker.StateMachine.XNodeEditor
{
    ...
    public partial class NodeEditorWindow
    {
        ...
        public static Type[] GetNodeTypes()
        {
            ...
            return GetDerivedTypes(typeof(AnimationBaker.StateMachine.XNode.Node));
        }
        ...
        public static Dictionary<Type, Color> GetNodeTint()
        {
            ...
            {
                var attribs = nodeTypes[i].GetCustomAttributes(typeof(AnimationBaker.StateMachine.XNode.Node.NodeTint), true);
                if (attribs == null || attribs.Length == 0) continue;
                AnimationBaker.StateMachine.XNode.Node.NodeTint attrib = attribs[0] as AnimationBaker.StateMachine.XNode.Node.NodeTint;
        ...
        public static Dictionary<Type, int> GetNodeWidth()
        {
            ...
            for (int i = 0; i < nodeTypes.Length; i++)
            {
                var attribs = nodeTypes[i].GetCustomAttributes(typeof(AnimationBaker.StateMachine.XNode.Node.NodeWidth), true);
                if (attribs == null || attribs.Length == 0) continue;
                AnimationBaker.StateMachine.XNode.Node.NodeWidth attrib = attribs[0] as AnimationBaker.StateMachine.XNode.Node.NodeWidth;
