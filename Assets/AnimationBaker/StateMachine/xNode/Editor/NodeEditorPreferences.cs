...
namespace AnimationBaker.StateMachine.XNodeEditor
{
    public static class NodeEditorPreferences
    {
        ...
        private static AnimationBaker.StateMachine.XNodeEditor.NodeGraphEditor lastEditor;
        ...
        {
            if (AnimationBaker.StateMachine.XNodeEditor.NodeEditorWindow.current == null) return null;
            if (lastEditor != AnimationBaker.StateMachine.XNodeEditor.NodeEditorWindow.current.graphEditor)
            {
                object[] attribs = AnimationBaker.StateMachine.XNodeEditor.NodeEditorWindow.current.graphEditor.GetType().GetCustomAttributes(typeof(AnimationBaker.StateMachine.XNodeEditor.NodeGraphEditor.CustomNodeGraphEditorAttribute), true);
                if (attribs.Length == 1)
                {
                    AnimationBaker.StateMachine.XNodeEditor.NodeGraphEditor.CustomNodeGraphEditorAttribute attrib = attribs[0] as AnimationBaker.StateMachine.XNodeEditor.NodeGraphEditor.CustomNodeGraphEditorAttribute;
                    lastEditor = AnimationBaker.StateMachine.XNodeEditor.NodeEditorWindow.current.graphEditor;
        ...
        [PreferenceItem("Animation Baker")]
