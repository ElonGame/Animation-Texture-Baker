...
namespace AnimationBaker.StateMachine.XNodeEditor
{
    ...
    class NodeEditorAssetModProcessor : UnityEditor.AssetModificationProcessor
    {
        ...
        private static AssetDeleteResult OnWillDeleteAsset(string path, RemoveAssetOptions options)
        {
            ...
            if (scriptType == null || (scriptType != typeof(AnimationBaker.StateMachine.XNode.Node) && !scriptType.IsSubclassOf(typeof(AnimationBaker.StateMachine.XNode.Node)))) return AssetDeleteResult.DidNotDelete;
            ...
            for (int i = 0; i < guids.Length; i++)
            {
                ...
                {
                    AnimationBaker.StateMachine.XNode.Node node = objs[k] as AnimationBaker.StateMachine.XNode.Node;
