...
namespace AnimationBaker.StateMachine.XNodeEditor
{
    ...
    [CustomNodeEditor(typeof(AnimationBaker.StateMachine.XNode.Node))]
    public class NodeEditor : AnimationBaker.StateMachine.XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, AnimationBaker.StateMachine.XNode.Node>
    {

        /// <summary> Fires every whenever a node was modified through the editor </summary>
        public static Action<AnimationBaker.StateMachine.XNode.Node> onUpdateNode;
        public static Dictionary<AnimationBaker.StateMachine.XNode.NodePort, Vector2> portPositions;
        ...
        AnimationBaker.StateMachine.XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, AnimationBaker.StateMachine.XNode.Node>.INodeEditorAttrib
        {
