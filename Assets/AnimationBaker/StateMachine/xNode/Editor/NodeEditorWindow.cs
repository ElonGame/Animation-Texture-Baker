...
namespace AnimationBaker.StateMachine.XNodeEditor
{
    ...
    public partial class NodeEditorWindow : EditorWindow
    {
        ...
        public Dictionary<AnimationBaker.StateMachine.XNode.NodePort, Rect> portConnectionPoints { get { return _portConnectionPoints; } }
        private Dictionary<AnimationBaker.StateMachine.XNode.NodePort, Rect> _portConnectionPoints = new Dictionary<AnimationBaker.StateMachine.XNode.NodePort, Rect>();
        public Dictionary<AnimationBaker.StateMachine.XNode.Node, Vector2> nodeSizes { get { return _nodeSizes; } }
        private Dictionary<AnimationBaker.StateMachine.XNode.Node, Vector2> _nodeSizes = new Dictionary<AnimationBaker.StateMachine.XNode.Node, Vector2>();
        public AnimationBaker.StateMachine.XNode.NodeGraph graph;
        ...
        public void SelectNode(AnimationBaker.StateMachine.XNode.Node node, bool add)
        {
            if (add)
            {
        ...
        public void DeselectNode(AnimationBaker.StateMachine.XNode.Node node)
        {
            List<Object> selection = new List<Object>(Selection.objects);
